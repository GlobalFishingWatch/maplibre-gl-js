...
describe('popup', () => {
    test('Popup#getElement returns a .maplibregl-popup element', () => {
        const map = createMap();
        const popup = new Popup().setText('Test').setLngLat([0, 0]).addTo(map);
    ...
    test('Popup does not close on map click events when the closeOnClick option is false', () => {
        const map = createMap();
        const popup = new Popup({closeOnClick: false}).setText('Test').setLngLat([0, 0]).addTo(map);
    ...
    test('Popup has no close button if closeButton option is false', () => {
        ...
        const popup = new Popup({closeButton: false}).setText('Test').setLngLat([0, 0]).addTo(map);

        expect(popup.getElement().querySelectorAll('.maplibregl-popup-close-button')).toHaveLength(0);
    });

    test('Popup does not close on map move events when the closeOnMove option is false', () => {
        const map = createMap();
        const popup = new Popup({closeOnMove: false}).setText('Test').setLngLat([0, 0]).addTo(map);
    ...
    test('Popup closes on map move events when the closeOnMove option is true', () => {
        const map = createMap();
        const popup = new Popup({closeOnMove: true}).setText('Test').setLngLat([0, 0]).addTo(map);
    ...
    test('Popup fires close event when removed', () => {
        ...
        new Popup().setText('Test').setLngLat([0, 0]).on('close', onClose).addTo(map).remove();
    ...
    test('Popup fires open event when added', () => {
        ...
        new Popup().setText('Test').setLngLat([0, 0]).on('open', onOpen).addTo(map);
    ...
    test('Popup content can be set via setText', () => {
        ...
        const popup = new Popup({closeButton: false}).setLngLat([0, 0]).addTo(map).setText('Test');
    ...
    test('Popup content can be set via setHTML', () => {
        ...
        const popup = new Popup({closeButton: false}).setLngLat([0, 0]).addTo(map).setHTML('<span>Test</span>');
    ...
    test('Popup content can be set via setDOMContent', () => {
        ...
        const popup = new Popup({closeButton: false}).setLngLat([0, 0]).addTo(map).setDOMContent(content);
    ...
    test('Popup content setters overwrite previous content', () => {
        ...
        const popup = new Popup({closeButton: false}).setLngLat([0, 0]).addTo(map);
    ...
    test('Popup is positioned at the specified LngLat in a world copy', () => {
        ...
        const popup = new Popup().setLngLat([270, 0]).setText('Test').addTo(map);
    ...
    test('Popup preserves object constancy of position after auto-wrapping center (left)', () => {
        ...
        const popup = new Popup().setLngLat([0, 0]).setText('Test').addTo(map);
    ...
    test('Popup wraps position after map move if it would otherwise go offscreen (right)', () => {
        ...
        const popup = new Popup().setLngLat([-355, 0]).setText('Test').addTo(map);
    ...
    test('Popup is repositioned at the specified LngLat', () => {
        ...
        const popup = new Popup().setLngLat([270, 0]).setText('Test').addTo(map).setLngLat([0, 0]);
    ...
    test('Popup anchors as specified by the anchor option', () => {
        const map = createMap();
        const popup = new Popup({anchor: 'top-left'}).setLngLat([0, 0]).setText('Test').addTo(map);
    ...
    (
        [
            ...
            [
                'right',
                new Point(containerWidth - 10, containerHeight / 2),
                'translate(-100%,-50%) translate(-10px,0px)'
            ],
            [
                'bottom-right',
                new Point(containerWidth - 10, containerHeight - 10),
                'translate(-100%,-100%) translate(-7px,-7px)'
            ],
            [
                'bottom',
                new Point(containerWidth / 2, containerHeight - 10),
                'translate(-50%,-100%) translate(0px,-10px)'
            ],
        ...
        ] as [PositionAnchor, Point, string][]
    ).forEach(args => {
        const anchor = args[0];
        const point = args[1];
        ...
        test(`Popup translation reflects offset and ${anchor} anchor`, () => {
            ...
            const popup = new Popup({anchor, offset: 10}).setLngLat([0, 0]).setText('Test').addTo(map);
    ...
    test('Popup automatically anchors to top if its bottom offset would push it off-screen', () => {
        ...
        const popup = new Popup(options).setLngLat([0, 0]).setText('Test').addTo(map);
    ...
    test('Popup is offset via a PointLike offset option', () => {
        ...
        const popup = new Popup({anchor: 'top-left', offset: [5, 10]}).setLngLat([0, 0]).setText('Test').addTo(map);
    ...
    test('Popup offset can be set via setOffset', () => {
        ...
        const popup = new Popup({offset: 5}).setLngLat([0, 0]).setText('Test').addTo(map);
    ...
    test('Popup can be removed and added again (#1477)', () => {
        ...
        new Popup().setText('Test').setLngLat([0, 0]).addTo(map).remove().addTo(map);
    ...
    test('Popup#addTo is idempotent (#1811)', () => {
        ...
        const popup = new Popup({closeButton: false}).setText('Test').setLngLat([0, 0]).addTo(map).addTo(map);
    ...
    test('Popup#remove is idempotent (#2395)', () => {
        ...
        new Popup({closeButton: false}).setText('Test').setLngLat([0, 0]).addTo(map).remove().remove();
    ...
    test('Popup adds classes from className option, methods for class manipulations works properly', () => {
        const map = createMap();
        const popup = new Popup({className: 'some classes'}).setText('Test').setLngLat([0, 0]).addTo(map);
    ...
    test('Cursor-tracked popup disappears on mouseout', () => {
        ...
        const popup = new Popup().setText('Test').trackPointer().addTo(map);
    ...
    test('Pointer-tracked popup is tagged with right class', () => {
        ...
        expect(popup._container.classList.value).toContain('maplibregl-popup-track-pointer');
    });

    test('Pointer-tracked popup with content set later is tagged with right class ', () => {
        const map = createMap();
        const popup = new Popup().trackPointer().addTo(map);
    ...
    test('Pointer-tracked popup that is set afterwards is tagged with right class ', () => {
        const map = createMap();
        const popup = new Popup().addTo(map);
    ...
    test('Pointer-tracked popup can be repositioned with setLngLat', () => {
        const map = createMap();
        const popup = new Popup().setText('Test').trackPointer().setLngLat([0, 0]).addTo(map);

        expect(popup._pos).toEqual(map.project([0, 0]));
        expect(popup._container.classList.value).not.toContain('maplibregl-popup-track-pointer');
    });
    ...
    test('Positioned popup can be set to track pointer', () => {
        const map = createMap();
        const popup = new Popup().setText('Test').setLngLat([0, 0]).trackPointer().addTo(map);
    ...
    test('Adding popup with no focusable content (Popup#setText) does not change the active element', () => {
        ...
        new Popup({closeButton: false}).setText('Test').setLngLat([0, 0]).addTo(createMap());
    ...
    test('Adding popup with no focusable content (Popup#setHTML) does not change the active element', () => {
        ...
        new Popup({closeButton: false}).setHTML('<span>Test</span>').setLngLat([0, 0]).addTo(createMap());
    ...
    test('Close button is focused if it is the only focusable element', () => {
        ...
        const popup = new Popup({closeButton: true}).setHTML('<span>Test</span>').setLngLat([0, 0]).addTo(createMap());
