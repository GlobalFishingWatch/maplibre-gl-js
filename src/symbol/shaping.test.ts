...
describe('shaping', () => {
    ...
    if (UPDATE)
        fs.writeFileSync(
            path.resolve(__dirname, '../../test/expected/text-shaping-null.json'),
            JSON.stringify(shaped, null, 2)
        );
    expect(shaped).toEqual(require('../../test/expected/text-shaping-null.json'));
    ...
    if (UPDATE)
        fs.writeFileSync(
            path.resolve(__dirname, '../../test/expected/text-shaping-default.json'),
            JSON.stringify(shaped, null, 2)
        );
    expect(shaped).toEqual(require('../../test/expected/text-shaping-default.json'));
    ...
    if (UPDATE)
        fs.writeFileSync(
            path.resolve(__dirname, '../../test/expected/text-shaping-spacing.json'),
            JSON.stringify(shaped, null, 2)
        );
    expect(shaped).toEqual(require('../../test/expected/text-shaping-spacing.json'));
    ...
    if (UPDATE)
        fs.writeFileSync(
            path.resolve(__dirname, '../../test/expected/text-shaping-linebreak.json'),
            JSON.stringify(shaped, null, 2)
        );
    ...
    if (UPDATE)
        fs.writeFileSync(
            path.resolve(__dirname, '../../test/expected/text-shaping-newline.json'),
            JSON.stringify(shaped, null, 2)
        );
    ...
    if (UPDATE)
        fs.writeFileSync(
            path.resolve(__dirname, '../../test/expected/text-shaping-newlines-in-middle.json'),
            JSON.stringify(shaped, null, 2)
        );
    ...
    shaped = shapeText(
        Formatted.fromString('三三\u200b三三\u200b三三\u200b三三三三三三\u200b三三'),
        glyphs,
        glyphPositions,
        images,
        fontStack,
    ...
    if (UPDATE)
        fs.writeFileSync(
            path.resolve(__dirname, '../../test/expected/text-shaping-zero-width-space.json'),
            JSON.stringify(shaped, null, 2)
        );
    ...
    test('basic image shaping', () => {
        const shaped = shapeText(
            new Formatted([sectionForImage('square')]),
            glyphs,
            glyphPositions,
            images,
            fontStack,
    ...
    test('images in horizontal layout', () => {
        ...
        if (UPDATE)
            fs.writeFileSync(
                path.resolve(__dirname, '../../test/expected/text-shaping-images-horizontal.json'),
                JSON.stringify(shaped, null, 2)
            );
    ...
    test('images in vertical layout', () => {
        ...
        if (UPDATE)
            fs.writeFileSync(
                path.resolve(__dirname, '../../test/expected/text-shaping-images-vertical.json'),
                JSON.stringify(shaped, null, 2)
            );
...
describe('fitIconToText', () => {
    ...
    test('icon-text-fit: width', () => {
        expect(fitIconToText(shapedIcon, shapedText, 'width', [0, 0, 0, 0], [0, 0], 24 / glyphSize)).toEqual({
        ...
        expect(fitIconToText(shapedIcon, shapedText, 'width', [0, 0, 0, 0], [3, 7], 24 / glyphSize)).toEqual({
            image: shapedIcon.image,
            collisionPadding: undefined,
            top: 7,
            right: 23,
        ...
        expect(fitIconToText(shapedIcon, shapedText, 'width', [0, 0, 0, 0], [0, 0], 12 / glyphSize)).toEqual({
            image: shapedIcon.image,
            collisionPadding: undefined,
            top: -5,
            right: 10,
        ...
        expect(fitIconToText(shapedIcon, shapedText, 'width', [5, 10, 5, 10], [0, 0], 12 / glyphSize)).toEqual({
            image: shapedIcon.image,
            collisionPadding: undefined,
            top: -5,
            right: 20,
    ...
    test('icon-text-fit: height', () => {
        expect(fitIconToText(shapedIcon, shapedText, 'height', [0, 0, 0, 0], [0, 0], 24 / glyphSize)).toEqual({
            image: shapedIcon.image,
            collisionPadding: undefined,
            top: -10,
            right: -10,
        ...
        expect(fitIconToText(shapedIcon, shapedText, 'height', [0, 0, 0, 0], [3, 7], 24 / glyphSize)).toEqual({
            image: shapedIcon.image,
            collisionPadding: undefined,
            top: -3,
            right: -7,
        ...
        expect(fitIconToText(shapedIcon, shapedText, 'height', [0, 0, 0, 0], [0, 0], 12 / glyphSize)).toEqual({
            image: shapedIcon.image,
            collisionPadding: undefined,
            top: -5,
            right: 0,
        ...
        expect(fitIconToText(shapedIcon, shapedText, 'height', [5, 10, 5, 10], [0, 0], 12 / glyphSize)).toEqual({
            image: shapedIcon.image,
            collisionPadding: undefined,
            top: -10,
            right: 0,
    ...
    test('icon-text-fit: both', () => {
        expect(fitIconToText(shapedIcon, shapedText, 'both', [0, 0, 0, 0], [0, 0], 24 / glyphSize)).toEqual({
            image: shapedIcon.image,
            collisionPadding: undefined,
            top: -10,
            right: 20,
        ...
        expect(fitIconToText(shapedIcon, shapedText, 'both', [0, 0, 0, 0], [3, 7], 24 / glyphSize)).toEqual({
            image: shapedIcon.image,
            collisionPadding: undefined,
            top: -3,
            right: 23,
        ...
        expect(fitIconToText(shapedIcon, shapedText, 'both', [0, 0, 0, 0], [0, 0], 12 / glyphSize)).toEqual({
            image: shapedIcon.image,
            collisionPadding: undefined,
            top: -5,
            right: 10,
        ...
        expect(fitIconToText(shapedIcon, shapedText, 'both', [5, 10, 5, 10], [0, 0], 12 / glyphSize)).toEqual({
            image: shapedIcon.image,
            collisionPadding: undefined,
            top: -10,
            right: 20,
        ...
        expect(fitIconToText(shapedIcon, shapedText, 'both', [0, 5, 10, 15], [0, 0], 12 / glyphSize)).toEqual({
            image: shapedIcon.image,
            collisionPadding: undefined,
            top: -5,
            right: 15,
