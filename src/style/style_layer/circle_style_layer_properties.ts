...
const layout: Properties<CircleLayoutProps> = new Properties({
    'circle-sort-key': new DataDrivenProperty(
        styleSpec['layout_circle']['circle-sort-key'] as any as StylePropertySpecification
    )
});
...
const paint: Properties<CirclePaintProps> = new Properties({
    'circle-radius': new DataDrivenProperty(
        styleSpec['paint_circle']['circle-radius'] as any as StylePropertySpecification
    ),
    'circle-color': new DataDrivenProperty(
        styleSpec['paint_circle']['circle-color'] as any as StylePropertySpecification
    ),
    'circle-blur': new DataDrivenProperty(
        styleSpec['paint_circle']['circle-blur'] as any as StylePropertySpecification
    ),
    'circle-opacity': new DataDrivenProperty(
        styleSpec['paint_circle']['circle-opacity'] as any as StylePropertySpecification
    ),
    'circle-translate': new DataConstantProperty(
        styleSpec['paint_circle']['circle-translate'] as any as StylePropertySpecification
    ),
    'circle-translate-anchor': new DataConstantProperty(
        styleSpec['paint_circle']['circle-translate-anchor'] as any as StylePropertySpecification
    ),
    'circle-pitch-scale': new DataConstantProperty(
        styleSpec['paint_circle']['circle-pitch-scale'] as any as StylePropertySpecification
    ),
    'circle-pitch-alignment': new DataConstantProperty(
        styleSpec['paint_circle']['circle-pitch-alignment'] as any as StylePropertySpecification
    ),
    'circle-stroke-width': new DataDrivenProperty(
        styleSpec['paint_circle']['circle-stroke-width'] as any as StylePropertySpecification
    ),
    'circle-stroke-color': new DataDrivenProperty(
        styleSpec['paint_circle']['circle-stroke-color'] as any as StylePropertySpecification
    ),
    'circle-stroke-opacity': new DataDrivenProperty(
        styleSpec['paint_circle']['circle-stroke-opacity'] as any as StylePropertySpecification
    )
});
