...
const paint: Properties<FillExtrusionPaintProps> = new Properties({
    'fill-extrusion-opacity': new DataConstantProperty(
        styleSpec['paint_fill-extrusion']['fill-extrusion-opacity'] as any as StylePropertySpecification
    ),
    'fill-extrusion-color': new DataDrivenProperty(
        styleSpec['paint_fill-extrusion']['fill-extrusion-color'] as any as StylePropertySpecification
    ),
    'fill-extrusion-translate': new DataConstantProperty(
        styleSpec['paint_fill-extrusion']['fill-extrusion-translate'] as any as StylePropertySpecification
    ),
    'fill-extrusion-translate-anchor': new DataConstantProperty(
        styleSpec['paint_fill-extrusion']['fill-extrusion-translate-anchor'] as any as StylePropertySpecification
    ),
    'fill-extrusion-pattern': new CrossFadedDataDrivenProperty(
        styleSpec['paint_fill-extrusion']['fill-extrusion-pattern'] as any as StylePropertySpecification
    ),
    'fill-extrusion-height': new DataDrivenProperty(
        styleSpec['paint_fill-extrusion']['fill-extrusion-height'] as any as StylePropertySpecification
    ),
    'fill-extrusion-base': new DataDrivenProperty(
        styleSpec['paint_fill-extrusion']['fill-extrusion-base'] as any as StylePropertySpecification
    ),
    'fill-extrusion-vertical-gradient': new DataConstantProperty(
        styleSpec['paint_fill-extrusion']['fill-extrusion-vertical-gradient'] as any as StylePropertySpecification
    )
});
