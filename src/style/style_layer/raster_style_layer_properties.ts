...
const paint: Properties<RasterPaintProps> = new Properties({
    'raster-opacity': new DataConstantProperty(
        styleSpec['paint_raster']['raster-opacity'] as any as StylePropertySpecification
    ),
    'raster-hue-rotate': new DataConstantProperty(
        styleSpec['paint_raster']['raster-hue-rotate'] as any as StylePropertySpecification
    ),
    'raster-brightness-min': new DataConstantProperty(
        styleSpec['paint_raster']['raster-brightness-min'] as any as StylePropertySpecification
    ),
    'raster-brightness-max': new DataConstantProperty(
        styleSpec['paint_raster']['raster-brightness-max'] as any as StylePropertySpecification
    ),
    'raster-saturation': new DataConstantProperty(
        styleSpec['paint_raster']['raster-saturation'] as any as StylePropertySpecification
    ),
    'raster-contrast': new DataConstantProperty(
        styleSpec['paint_raster']['raster-contrast'] as any as StylePropertySpecification
    ),
    'raster-resampling': new DataConstantProperty(
        styleSpec['paint_raster']['raster-resampling'] as any as StylePropertySpecification
    ),
    'raster-fade-duration': new DataConstantProperty(
        styleSpec['paint_raster']['raster-fade-duration'] as any as StylePropertySpecification
    )
});
