...
const paint: Properties<HeatmapPaintProps> = new Properties({
    'heatmap-radius': new DataDrivenProperty(
        styleSpec['paint_heatmap']['heatmap-radius'] as any as StylePropertySpecification
    ),
    'heatmap-weight': new DataDrivenProperty(
        styleSpec['paint_heatmap']['heatmap-weight'] as any as StylePropertySpecification
    ),
    'heatmap-intensity': new DataConstantProperty(
        styleSpec['paint_heatmap']['heatmap-intensity'] as any as StylePropertySpecification
    ),
    'heatmap-color': new ColorRampProperty(
        styleSpec['paint_heatmap']['heatmap-color'] as any as StylePropertySpecification
    ),
    'heatmap-opacity': new DataConstantProperty(
        styleSpec['paint_heatmap']['heatmap-opacity'] as any as StylePropertySpecification
    )
});
