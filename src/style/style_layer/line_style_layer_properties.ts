...
const layout: Properties<LineLayoutProps> = new Properties({
    ...
    'line-miter-limit': new DataConstantProperty(
        styleSpec['layout_line']['line-miter-limit'] as any as StylePropertySpecification
    ),
    'line-round-limit': new DataConstantProperty(
        styleSpec['layout_line']['line-round-limit'] as any as StylePropertySpecification
    ),
    'line-sort-key': new DataDrivenProperty(
        styleSpec['layout_line']['line-sort-key'] as any as StylePropertySpecification
    )
});
...
const paint: Properties<LinePaintProps> = new Properties({
    'line-opacity': new DataDrivenProperty(
        styleSpec['paint_line']['line-opacity'] as any as StylePropertySpecification
    ),
    ...
    'line-translate': new DataConstantProperty(
        styleSpec['paint_line']['line-translate'] as any as StylePropertySpecification
    ),
    'line-translate-anchor': new DataConstantProperty(
        styleSpec['paint_line']['line-translate-anchor'] as any as StylePropertySpecification
    ),
    ...
    'line-gap-width': new DataDrivenProperty(
        styleSpec['paint_line']['line-gap-width'] as any as StylePropertySpecification
    ),
    ...
    'line-dasharray': new CrossFadedProperty(
        styleSpec['paint_line']['line-dasharray'] as any as StylePropertySpecification
    ),
    'line-pattern': new CrossFadedDataDrivenProperty(
        styleSpec['paint_line']['line-pattern'] as any as StylePropertySpecification
    ),
    'line-gradient': new ColorRampProperty(
        styleSpec['paint_line']['line-gradient'] as any as StylePropertySpecification
    )
});
