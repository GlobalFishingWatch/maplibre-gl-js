...
const layout: Properties<FillLayoutProps> = new Properties({
    'fill-sort-key': new DataDrivenProperty(
        styleSpec['layout_fill']['fill-sort-key'] as any as StylePropertySpecification
    )
});
...
const paint: Properties<FillPaintProps> = new Properties({
    'fill-antialias': new DataConstantProperty(
        styleSpec['paint_fill']['fill-antialias'] as any as StylePropertySpecification
    ),
    'fill-opacity': new DataDrivenProperty(
        styleSpec['paint_fill']['fill-opacity'] as any as StylePropertySpecification
    ),
    ...
    'fill-outline-color': new DataDrivenProperty(
        styleSpec['paint_fill']['fill-outline-color'] as any as StylePropertySpecification
    ),
    'fill-translate': new DataConstantProperty(
        styleSpec['paint_fill']['fill-translate'] as any as StylePropertySpecification
    ),
    'fill-translate-anchor': new DataConstantProperty(
        styleSpec['paint_fill']['fill-translate-anchor'] as any as StylePropertySpecification
    ),
    'fill-pattern': new CrossFadedDataDrivenProperty(
        styleSpec['paint_fill']['fill-pattern'] as any as StylePropertySpecification
    )
});
