...
const paint: Properties<HillshadePaintProps> = new Properties({
    'hillshade-illumination-direction': new DataConstantProperty(
        styleSpec['paint_hillshade']['hillshade-illumination-direction'] as any as StylePropertySpecification
    ),
    'hillshade-illumination-anchor': new DataConstantProperty(
        styleSpec['paint_hillshade']['hillshade-illumination-anchor'] as any as StylePropertySpecification
    ),
    'hillshade-exaggeration': new DataConstantProperty(
        styleSpec['paint_hillshade']['hillshade-exaggeration'] as any as StylePropertySpecification
    ),
    'hillshade-shadow-color': new DataConstantProperty(
        styleSpec['paint_hillshade']['hillshade-shadow-color'] as any as StylePropertySpecification
    ),
    'hillshade-highlight-color': new DataConstantProperty(
        styleSpec['paint_hillshade']['hillshade-highlight-color'] as any as StylePropertySpecification
    ),
    'hillshade-accent-color': new DataConstantProperty(
        styleSpec['paint_hillshade']['hillshade-accent-color'] as any as StylePropertySpecification
    )
});
