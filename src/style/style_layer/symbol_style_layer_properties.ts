...
import {ColorType} from '../../style-spec/expression/types';
...
const layout: Properties<SymbolLayoutProps> = new Properties({
    'symbol-placement': new DataConstantProperty(
        styleSpec['layout_symbol']['symbol-placement'] as any as StylePropertySpecification
    ),
    'symbol-spacing': new DataConstantProperty(
        styleSpec['layout_symbol']['symbol-spacing'] as any as StylePropertySpecification
    ),
    'symbol-avoid-edges': new DataConstantProperty(
        styleSpec['layout_symbol']['symbol-avoid-edges'] as any as StylePropertySpecification
    ),
    'symbol-sort-key': new DataDrivenProperty(
        styleSpec['layout_symbol']['symbol-sort-key'] as any as StylePropertySpecification
    ),
    'symbol-z-order': new DataConstantProperty(
        styleSpec['layout_symbol']['symbol-z-order'] as any as StylePropertySpecification
    ),
    'icon-allow-overlap': new DataConstantProperty(
        styleSpec['layout_symbol']['icon-allow-overlap'] as any as StylePropertySpecification
    ),
    'icon-ignore-placement': new DataConstantProperty(
        styleSpec['layout_symbol']['icon-ignore-placement'] as any as StylePropertySpecification
    ),
    'icon-optional': new DataConstantProperty(
        styleSpec['layout_symbol']['icon-optional'] as any as StylePropertySpecification
    ),
    'icon-rotation-alignment': new DataConstantProperty(
        styleSpec['layout_symbol']['icon-rotation-alignment'] as any as StylePropertySpecification
    ),
    ...
    'icon-text-fit': new DataConstantProperty(
        styleSpec['layout_symbol']['icon-text-fit'] as any as StylePropertySpecification
    ),
    'icon-text-fit-padding': new DataConstantProperty(
        styleSpec['layout_symbol']['icon-text-fit-padding'] as any as StylePropertySpecification
    ),
    ...
    'icon-rotate': new DataDrivenProperty(
        styleSpec['layout_symbol']['icon-rotate'] as any as StylePropertySpecification
    ),
    'icon-padding': new DataConstantProperty(
        styleSpec['layout_symbol']['icon-padding'] as any as StylePropertySpecification
    ),
    'icon-keep-upright': new DataConstantProperty(
        styleSpec['layout_symbol']['icon-keep-upright'] as any as StylePropertySpecification
    ),
    'icon-offset': new DataDrivenProperty(
        styleSpec['layout_symbol']['icon-offset'] as any as StylePropertySpecification
    ),
    'icon-anchor': new DataDrivenProperty(
        styleSpec['layout_symbol']['icon-anchor'] as any as StylePropertySpecification
    ),
    'icon-pitch-alignment': new DataConstantProperty(
        styleSpec['layout_symbol']['icon-pitch-alignment'] as any as StylePropertySpecification
    ),
    'text-pitch-alignment': new DataConstantProperty(
        styleSpec['layout_symbol']['text-pitch-alignment'] as any as StylePropertySpecification
    ),
    'text-rotation-alignment': new DataConstantProperty(
        styleSpec['layout_symbol']['text-rotation-alignment'] as any as StylePropertySpecification
    ),
    ...
    'text-max-width': new DataDrivenProperty(
        styleSpec['layout_symbol']['text-max-width'] as any as StylePropertySpecification
    ),
    'text-line-height': new DataConstantProperty(
        styleSpec['layout_symbol']['text-line-height'] as any as StylePropertySpecification
    ),
    'text-letter-spacing': new DataDrivenProperty(
        styleSpec['layout_symbol']['text-letter-spacing'] as any as StylePropertySpecification
    ),
    'text-justify': new DataDrivenProperty(
        styleSpec['layout_symbol']['text-justify'] as any as StylePropertySpecification
    ),
    'text-radial-offset': new DataDrivenProperty(
        styleSpec['layout_symbol']['text-radial-offset'] as any as StylePropertySpecification
    ),
    'text-variable-anchor': new DataConstantProperty(
        styleSpec['layout_symbol']['text-variable-anchor'] as any as StylePropertySpecification
    ),
    'text-anchor': new DataDrivenProperty(
        styleSpec['layout_symbol']['text-anchor'] as any as StylePropertySpecification
    ),
    'text-max-angle': new DataConstantProperty(
        styleSpec['layout_symbol']['text-max-angle'] as any as StylePropertySpecification
    ),
    'text-writing-mode': new DataConstantProperty(
        styleSpec['layout_symbol']['text-writing-mode'] as any as StylePropertySpecification
    ),
    'text-rotate': new DataDrivenProperty(
        styleSpec['layout_symbol']['text-rotate'] as any as StylePropertySpecification
    ),
    'text-padding': new DataConstantProperty(
        styleSpec['layout_symbol']['text-padding'] as any as StylePropertySpecification
    ),
    'text-keep-upright': new DataConstantProperty(
        styleSpec['layout_symbol']['text-keep-upright'] as any as StylePropertySpecification
    ),
    'text-transform': new DataDrivenProperty(
        styleSpec['layout_symbol']['text-transform'] as any as StylePropertySpecification
    ),
    'text-offset': new DataDrivenProperty(
        styleSpec['layout_symbol']['text-offset'] as any as StylePropertySpecification
    ),
    'text-allow-overlap': new DataConstantProperty(
        styleSpec['layout_symbol']['text-allow-overlap'] as any as StylePropertySpecification
    ),
    'text-ignore-placement': new DataConstantProperty(
        styleSpec['layout_symbol']['text-ignore-placement'] as any as StylePropertySpecification
    ),
    'text-optional': new DataConstantProperty(
        styleSpec['layout_symbol']['text-optional'] as any as StylePropertySpecification
    )
});
...
const paint: Properties<SymbolPaintProps> = new Properties({
    'icon-opacity': new DataDrivenProperty(
        styleSpec['paint_symbol']['icon-opacity'] as any as StylePropertySpecification
    ),
    ...
    'icon-halo-color': new DataDrivenProperty(
        styleSpec['paint_symbol']['icon-halo-color'] as any as StylePropertySpecification
    ),
    'icon-halo-width': new DataDrivenProperty(
        styleSpec['paint_symbol']['icon-halo-width'] as any as StylePropertySpecification
    ),
    'icon-halo-blur': new DataDrivenProperty(
        styleSpec['paint_symbol']['icon-halo-blur'] as any as StylePropertySpecification
    ),
    'icon-translate': new DataConstantProperty(
        styleSpec['paint_symbol']['icon-translate'] as any as StylePropertySpecification
    ),
    'icon-translate-anchor': new DataConstantProperty(
        styleSpec['paint_symbol']['icon-translate-anchor'] as any as StylePropertySpecification
    ),
    'text-opacity': new DataDrivenProperty(
        styleSpec['paint_symbol']['text-opacity'] as any as StylePropertySpecification
    ),
    'text-color': new DataDrivenProperty(styleSpec['paint_symbol']['text-color'] as any as StylePropertySpecification, {
        runtimeType: ColorType,
        getOverride: o => o.textColor,
        hasOverride: o => !!o.textColor
    }),
    'text-halo-color': new DataDrivenProperty(
        styleSpec['paint_symbol']['text-halo-color'] as any as StylePropertySpecification
    ),
    'text-halo-width': new DataDrivenProperty(
        styleSpec['paint_symbol']['text-halo-width'] as any as StylePropertySpecification
    ),
    'text-halo-blur': new DataDrivenProperty(
        styleSpec['paint_symbol']['text-halo-blur'] as any as StylePropertySpecification
    ),
    'text-translate': new DataConstantProperty(
        styleSpec['paint_symbol']['text-translate'] as any as StylePropertySpecification
    ),
    'text-translate-anchor': new DataConstantProperty(
        styleSpec['paint_symbol']['text-translate-anchor'] as any as StylePropertySpecification
    )
});
