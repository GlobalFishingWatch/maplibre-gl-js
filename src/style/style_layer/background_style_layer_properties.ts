...
const paint: Properties<BackgroundPaintProps> = new Properties({
    'background-color': new DataConstantProperty(
        styleSpec['paint_background']['background-color'] as any as StylePropertySpecification
    ),
    'background-pattern': new CrossFadedProperty(
        styleSpec['paint_background']['background-pattern'] as any as StylePropertySpecification
    ),
    'background-opacity': new DataConstantProperty(
        styleSpec['paint_background']['background-opacity'] as any as StylePropertySpecification
    )
});
