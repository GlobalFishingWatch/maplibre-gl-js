...
export type CompositeFunctionSpecification<T> =
    ...
    | {
          type: 'categorical';
          stops: Array<[{zoom: number; value: string | number | boolean}, T]>;
          property: string;
          default?: T;
      };
...
export type PropertyValueSpecification<T> = T | CameraFunctionSpecification<T> | ExpressionSpecificationArray;
