...
function updateUI(benchmarks, finished) {
    finished = !!finished;
    ReactDOM.render(React.createElement(BenchmarksTable, { benchmarks: benchmarks, finished: finished }), document.getElementById('benchmarks'));
}
...
//# sourceMappingURL=benchmarks_view.js.map